...
export type ReplySuggestionSource = { knowledge_item_id: string; title: string; chunk_index: number; page_number?: number | null }
export type ReplySuggestionRequest = { ticket_id: string; job_id: string; job_type: string; status: string }
export type ReplySuggestionJob = { ticket_id: string; job_id: string; job_type: string; status: string; retry_count?: number; error_message?: string | null; reply_id?: string | null; source_refs?: ReplySuggestionSource[]; created_at: string; updated_at: string }
